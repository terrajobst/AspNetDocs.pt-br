...
Para a instalação do Docker, examine as informações em [Docker para Windows: What to know before you install](https://docs.docker.com/docker-for-windows/install/#what-to-know-before-you-install) (Docker Desktop for Windows: o que saber antes de instalar). Em seguida, instale o [Docker for Windows](https://docs.docker.com/docker-for-windows/install/).
...
* [Azure Service Fabric: Preparar o ambiente de desenvolvimento](/azure/service-fabric/service-fabric-get-started)
