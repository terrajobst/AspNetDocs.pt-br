...
**Observação:** Você geralmente deseja localizar somente o texto e não o HTML.
...
* Globalização (G11N): O processo de criação de aplicativos dão suporte a diferentes idiomas e regiões.
* Localização (L10N): O processo de personalizar um aplicativo para um determinado idioma e região.
* Internacionalização (I18N): Descreve a globalização e localização.
...
* Cultura específica: Uma cultura que tem um idioma especificado e uma região. (por exemplo, "en-US", "en-GB", "es-CL")
