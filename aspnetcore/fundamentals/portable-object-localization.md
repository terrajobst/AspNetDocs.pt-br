...
- `#:`: Um comentário que indica o contexto da cadeia de caracteres a ser traduzido. A mesma cadeia de caracteres pode ser traduzida de modo diferente, dependendo do local em que ela está sendo usada.
...
**Observação:** Em um cenário do mundo real, uma variável deve ser usada para representar a contagem. Aqui, repetimos o mesmo código com três valores diferentes para expor um caso muito específico.
