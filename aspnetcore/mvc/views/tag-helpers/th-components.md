...
* *Opcional*: Aplicar uma [[EditorBrowsable(EditorBrowsableState.Never)]](xref:System.ComponentModel.EditorBrowsableAttribute) atributo à classe para suprimir a exibição do tipo no IntelliSense.
