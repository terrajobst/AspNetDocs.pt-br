...
- Funcionalidade do SignalR deve ser adicionado a um aplicativo existente que é executado em um serviço do Windows, a função de trabalho do Azure ou outro processo.
