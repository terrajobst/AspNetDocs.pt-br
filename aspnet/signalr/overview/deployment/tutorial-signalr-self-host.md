...
<span data-ttu-id="b4c89-127">Motivos para não hospedar no IIS:</span><span class="sxs-lookup"><span data-stu-id="b4c89-127">Reasons for not hosting in IIS include:</span></span>
