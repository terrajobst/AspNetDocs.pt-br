...
- [Diretrizes](overview/index.md)
    ...
    - [Trabalhando com os Dados](overview/data/index.md)
        ...
        - [Uso da API Web 2 com o Entity Framework 6](overview/data/using-web-api-with-entity-framework/index.md)
            ...
            - [Propagar o banco de dados](overview/data/using-web-api-with-entity-framework/part-3.md)
            - [Tratamento de relações de entidade](overview/data/using-web-api-with-entity-framework/part-4.md)
            - [Criar DTOs (objetos de transferência de dados)](overview/data/using-web-api-with-entity-framework/part-5.md)
            - [Criar o cliente de JavaScript](overview/data/using-web-api-with-entity-framework/part-6.md)
            - [Criar a exibição (interface do usuário)](overview/data/using-web-api-with-entity-framework/part-7.md)
            - [Exibir detalhes do item](overview/data/using-web-api-with-entity-framework/part-8.md)
            - [Adicionar um novo item ao banco de dados](overview/data/using-web-api-with-entity-framework/part-9.md)
    ...
    - [Clientes móveis](overview/mobile-clients/index.md)
        ...
        - [Chamar a API Web em um aplicativo do Windows Phone 8 (C#)](overview/mobile-clients/calling-web-api-from-a-windows-phone-8-application.md)
    - [OData](overview/odata-support-in-aspnet-web-api/index.md)
        ...
        - [OData v4](overview/odata-support-in-aspnet-web-api/odata-v4/index.md)
            ...
            - [Criar um aplicativo cliente do OData v4 (C#)](overview/odata-support-in-aspnet-web-api/odata-v4/create-an-odata-v4-client-app.md)
            ...
            - [Contenção no OData v4](overview/odata-support-in-aspnet-web-api/odata-v4/odata-containment-in-web-api-22.md)
        ...
        - [Diretrizes de segurança para o OData da API Web 2](overview/odata-support-in-aspnet-web-api/odata-security-guidance.md)
    - [Serialização e o model binding](overview/formats-and-model-binding/index.md)

        - [Formatadores de mídia na API Web 2](overview/formats-and-model-binding/media-formatters.md)
        - [Serialização de XML e JSON na API Web](overview/formats-and-model-binding/json-and-xml-serialization.md)
        - [Suporte a BSON na API Web 2.1](overview/formats-and-model-binding/bson-support-in-web-api-21.md)
    ...
    - [Versões](overview/releases/index.md)
        ...
        - [Novidades no ASP.NET Web API 2.1](overview/releases/whats-new-in-aspnet-web-api-21.md)
