...
## <a name="example-adding-a-custom-response-header"></a>Exemplo: Adicionando um cabeçalho de resposta personalizada
...
## <a name="example-checking-for-an-api-key"></a>Exemplo: Procurando uma chave de API
