...
---
<a name="aspnet-4-quick-hit--easy-state-compression"></a>ASP.NET 4 "Acertar rápido" – compactação de estado fácil
====================
por [Joe Stagner](https://github.com/JoeStagner)

Neste vídeo, que você aprenderá a usar a opção de configuração compressionEnabled para compactar (e descompactar) serializado de estado de sessão. 
