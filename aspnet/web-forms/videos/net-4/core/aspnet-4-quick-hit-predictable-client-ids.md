...
---
# <a name="aspnet-4-quick-hit---predictable-client-ids"></a>ASP.NET 4 "acesso rápido"-IDs de cliente previsíveis

por [Joe Stagner](https://github.com/JoeStagner)

Neste vídeo, você aprenderá sobre a propriedade ClientIDmode, que permite especificar mais precisamente como a ID do cliente é gerada para controles. 

[&#9654;Assistir ao vídeo (10 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-predictable-client-ids)
