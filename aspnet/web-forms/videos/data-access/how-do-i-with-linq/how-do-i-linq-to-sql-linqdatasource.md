...
---
# <a name="how-do-i-linq-to-sql-linqdatasource"></a>[Como fazer:] LINQ to SQL: LinqDataSource

por [Scott Stanfield](https://github.com/scottstanfield)

O novo controle asp: LinqDataSource .NET 3.5 torna fácil a associação aos elementos de interface do usuário. Na verdade, nenhum código foi escrito ou ferido durante a criação deste vídeo. Consultar, atualizar, excluir, paginação, classificação, tudo pronto por meio de LINQ e o LinqDataSource.
