...
### <a name="step-2-registering-elmahs-http-module-and-handler"></a>Etapa 2: Registrando o módulo HTTP e o manipulador do ELMAH
...
**Figura 5**: Explore os valores da coleção de variáveis de servidor no momento do erro  
