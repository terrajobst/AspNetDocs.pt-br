...
[![TAplicativo de Web do catálogo revisões s banco de dados é composto de quatro tabelas](deploying-a-database-vb/_static/image2.jpg)](deploying-a-database-vb/_static/image1.jpg) 

**Figura 1**: O aplicativo de Web do catálogo revisões banco de dados é composto de quatro tabelas ([clique para exibir a imagem em tamanho normal](deploying-a-database-vb/_static/image3.jpg))
...
[![Tele tem página de gênero de tecnologia](deploying-a-database-vb/_static/image5.jpg)](deploying-a-database-vb/_static/image4.jpg) 
...
[![Tele revisão para ensinar a mesmo ASP.NET 3.5 in 24 horas](deploying-a-database-vb/_static/image8.jpg)](deploying-a-database-vb/_static/image7.jpg) 

**Figura 3**: A revisão *ensinar por conta própria ASP.NET 3.5 in 24 horas* ([clique para exibir a imagem em tamanho normal](deploying-a-database-vb/_static/image9.jpg))
...
[![Localizar o banco de dados no Server Explorer ou Gerenciador de banco de dados](deploying-a-database-vb/_static/image11.jpg)](deploying-a-database-vb/_static/image10.jpg) 
...
[![Tele tela de inicial do Assistente de publicação de banco de dados](deploying-a-database-vb/_static/image14.jpg)](deploying-a-database-vb/_static/image13.jpg) 

**Figura 5**: A tela de abertura de Assistente de publicação do banco de dados ([clique para exibir a imagem em tamanho normal](deploying-a-database-vb/_static/image15.jpg))
...
[![Tele tela de inicial do Assistente de publicação de banco de dados](deploying-a-database-vb/_static/image17.jpg)](deploying-a-database-vb/_static/image16.jpg) 

**Figura 6**: A tela de abertura de Assistente de publicação do banco de dados ([clique para exibir a imagem em tamanho normal](deploying-a-database-vb/_static/image18.jpg))
...
[![Script o banco de dados para um arquivo ou publicá-lo diretamente no seu provedor de Host da Web](deploying-a-database-vb/_static/image20.jpg)](deploying-a-database-vb/_static/image19.jpg) 
...
[![Sespecificar opções de publicação](deploying-a-database-vb/_static/image23.jpg)](deploying-a-database-vb/_static/image22.jpg) 

**Figura 8**: Especificar opções de publicação ([clique para exibir a imagem em tamanho normal](deploying-a-database-vb/_static/image24.jpg))
...
[![Conectar-se ao seu provedor de Host Web s servidor de banco de dados](deploying-a-database-vb/_static/image26.jpg)](deploying-a-database-vb/_static/image25.jpg) 
...
[![Conectar-se ao seu provedor de Host Web s servidor de banco de dados](deploying-a-database-vb/_static/image29.jpg)](deploying-a-database-vb/_static/image28.jpg) 
...
[![Tele banco de dados de objetos foram duplicados no banco de dados de produção](deploying-a-database-vb/_static/image32.jpg)](deploying-a-database-vb/_static/image31.jpg) 
...
[![Tele banco de dados de produção contém os mesmos dados como no desenvolvimento de banco de dados](deploying-a-database-vb/_static/image35.jpg)](deploying-a-database-vb/_static/image34.jpg) 
