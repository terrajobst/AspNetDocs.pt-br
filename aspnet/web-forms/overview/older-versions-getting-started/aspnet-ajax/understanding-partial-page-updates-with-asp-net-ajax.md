...
| Scripts | Collection&lt;Script-Reference&gt; | Obtém uma coleção de referências de script que será enviada ao cliente. |
| Serviços | Collection&lt;Service-Reference&gt; | Obtém uma coleção de referências de proxy de serviço Web que será enviada ao cliente. |
