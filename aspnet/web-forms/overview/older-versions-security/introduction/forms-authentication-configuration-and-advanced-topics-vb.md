...
|          tempo limite           |                                                                                                                               Especifica o tempo, em minutos, após o qual o cookie de tíquete de autenticação expira. O valor padrão é 30. A política de tempo limite de tíquete de autenticação é discutida mais detalhadamente na seção especificando o valor de tempo limite do tíquete s.                                                                                                                               |
