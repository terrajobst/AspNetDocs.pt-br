...
> 
> Consulte este vídeo para obter mais informações sobre este tópico: [Usando a autenticação de formulários básica no ASP.NET](# "using-basic-forms-authentication-in-aspnet").
...
**Figura 11**: Quando visitar anonimamente e, em um Link de Log é exibido
...
**Figura 15**: As exibições de controle LoginView "Bem-vindo de volta, Jisun."
