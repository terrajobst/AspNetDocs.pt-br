...
- James Chaney ([jchaney@agvance.net](mailto:jchaney@agvance.net))  
  Visual Studio 2012 relacionados ao código de exemplo no MSDN: [ASP.NET 4.5 do Web Forms série de tutoriais no Visual Basic](https://code.msdn.microsoft.com/ASPNET-45-Web-Forms-f37f0f63)
