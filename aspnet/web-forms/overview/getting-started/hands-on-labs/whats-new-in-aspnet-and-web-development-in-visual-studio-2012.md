...
6. Desfazer as alterações ao esquema de destino para validação de barra de ferramentas, escolhendo o tipo de documento: XHTML5 na lista suspensa.
