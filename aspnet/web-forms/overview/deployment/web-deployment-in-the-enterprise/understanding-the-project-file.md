...
Para recuperar um valor de propriedade, use o formato *$ (PropertyName)* . Por exemplo, para recuperar o valor da **ServerName** propriedade, você digitaria:
