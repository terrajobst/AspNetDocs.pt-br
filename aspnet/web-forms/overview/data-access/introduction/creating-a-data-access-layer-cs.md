...
[![Ccriar um Site New File System-Based](creating-a-data-access-layer-cs/_static/image2.png)](creating-a-data-access-layer-cs/_static/image1.png)
...
## <a name="step-2-creating-the-data-access-layer"></a>Etapa 2: Criando a camada de acesso de dados
...
[![ACódigo de acesso a dados é relegados a DAL de ll](creating-a-data-access-layer-cs/_static/image6.png)](creating-a-data-access-layer-cs/_static/image5.png)

**Figura 3**: Todo código de acesso de dados é relegados a DAL ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image7.png))
...
[![Cescolher o modo para adicionar um novo conjunto de dados ao seu projeto](creating-a-data-access-layer-cs/_static/image9.png)](creating-a-data-access-layer-cs/_static/image8.png)

**Figura 4**: Optar por adicionar um novo conjunto de dados ao seu projeto ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image10.png))
...
[![Cescolher o modo de banco de dados Northwind na lista suspensa](creating-a-data-access-layer-cs/_static/image12.png)](creating-a-data-access-layer-cs/_static/image11.png)
...
[![Sa cadeia de caracteres de Conexão para Web. config do Ave](creating-a-data-access-layer-cs/_static/image15.png)](creating-a-data-access-layer-cs/_static/image14.png)

**Figura 6**: Salvar a cadeia de Conexão **Web. config** ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image16.png))
...
[![Qos dados usando uma instrução de SQL Ad Hoc de ulta](creating-a-data-access-layer-cs/_static/image18.png)](creating-a-data-access-layer-cs/_static/image17.png)
...
[![Eigite SQL consulta para a caixa de texto](creating-a-data-access-layer-cs/_static/image21.png)](creating-a-data-access-layer-cs/_static/image20.png)
...
[![Ccriar a consulta graficamente, por meio do Editor de consultas](creating-a-data-access-layer-cs/_static/image24.png)](creating-a-data-access-layer-cs/_static/image23.png)
...
[![SEscolha somente as Generate Insert, Update e Delete instruções opção](creating-a-data-access-layer-cs/_static/image27.png)](creating-a-data-access-layer-cs/_static/image26.png)
...
[![Calterar o nome do método de GetData para GetProducts](creating-a-data-access-layer-cs/_static/image30.png)](creating-a-data-access-layer-cs/_static/image29.png)
...
[![Tele DataTable de produtos e ProductsTableAdapter foram adicionados ao conjunto de dados tipado](creating-a-data-access-layer-cs/_static/image33.png)](creating-a-data-access-layer-cs/_static/image32.png)
...
[![TEle lista de produtos é exibido em um GridView](creating-a-data-access-layer-cs/_static/image36.png)](creating-a-data-access-layer-cs/_static/image35.png)
...
[![Cescolher o modo para criar um selecione instrução que retorna linhas](creating-a-data-access-layer-cs/_static/image40.png)](creating-a-data-access-layer-cs/_static/image39.png)

**Figura 15**: Optar por criar uma **selecionar** instrução que retorna linhas ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image41.png))
...
[![EInsira uma consulta para somente retornam os produtos em uma categoria especificada](creating-a-data-access-layer-cs/_static/image43.png)](creating-a-data-access-layer-cs/_static/image42.png)
...
[![Cescolher o modo de nomes para os métodos TableAdapter](creating-a-data-access-layer-cs/_static/image46.png)](creating-a-data-access-layer-cs/_static/image45.png)
...
[![TMangueira produtos pertencentes à categoria de bebidas é mostradas](creating-a-data-access-layer-cs/_static/image50.png)](creating-a-data-access-layer-cs/_static/image49.png)

**Figura 19**: Pertencendo esses produtos na categoria Bebidas são mostrados ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image51.png))
...
[![TMangueira de produtos na categoria Bebidas é exibidas](creating-a-data-access-layer-cs/_static/image53.png)](creating-a-data-access-layer-cs/_static/image52.png)

**Figura 20**: Esses produtos na categoria Bebidas são exibidos ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image54.png))
...
[![EACH inserir, atualizar e excluir a solicitação é enviada para o banco de dados imediatamente](creating-a-data-access-layer-cs/_static/image56.png)](creating-a-data-access-layer-cs/_static/image55.png)
...
[![Aé invocado ll que alterações são sincronizadas com o banco de dados quando o método de atualização](creating-a-data-access-layer-cs/_static/image59.png)](creating-a-data-access-layer-cs/_static/image58.png)

**Figura 22**: Todas as alterações são sincronizadas com o banco de dados quando o método Update é chamado ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image60.png))
...
[![Tele TableAdapter tem InsertCommand, UpdateCommand e propriedades DeleteCommand](creating-a-data-access-layer-cs/_static/image62.png)](creating-a-data-access-layer-cs/_static/image61.png)

**Figura 23**: Tem o TableAdapter **InsertCommand**, **UpdateCommand**, e **DeleteCommand** propriedades ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image63.png))
...
[![Configurar a inserção, atualização e excluir instruções no construtor de consultas](creating-a-data-access-layer-cs/_static/image65.png)](creating-a-data-access-layer-cs/_static/image64.png)
...
[![Ccriar um método para adicionar uma nova linha à tabela Products](creating-a-data-access-layer-cs/_static/image68.png)](creating-a-data-access-layer-cs/_static/image67.png)

**Figura 25**: Crie um método para adicionar uma linha nova para o **produtos** tabela ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image69.png))
...
[![Augment a consulta para retornar o valor de SCOPE_IDENTITY ()](creating-a-data-access-layer-cs/_static/image71.png)](creating-a-data-access-layer-cs/_static/image70.png)

**Figura 26**: Ampliar a consulta para retornar os **escopo\_IDENTITY()** valor ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image72.png))


Por fim, nomeie o novo método **InsertProduct**.


[![SET o novo nome de método para InsertProduct](creating-a-data-access-layer-cs/_static/image74.png)](creating-a-data-access-layer-cs/_static/image73.png)
...
[![Calterar a propriedade ExecuteMode para escalar](creating-a-data-access-layer-cs/_static/image77.png)](creating-a-data-access-layer-cs/_static/image76.png)

**Figura 28**: Alterar o **ExecuteMode** propriedade **escalar** ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image78.png))
...
[![Utualização a instrução SELECT para o método GetProducts()](creating-a-data-access-layer-cs/_static/image80.png)](creating-a-data-access-layer-cs/_static/image79.png)
...
[![Tele DataSet Designer após os quatro TableAdapters foram adicionados](creating-a-data-access-layer-cs/_static/image84.png)](creating-a-data-access-layer-cs/_static/image83.png)
...
[![Tele tem o arquivo de definição de esquema XML (XSD) para o conjunto de dados tipados do Northwind](creating-a-data-access-layer-cs/_static/image87.png)](creating-a-data-access-layer-cs/_static/image86.png)

**Figura 32**: O arquivo de definição de esquema XML (XSD) para o conjunto de dados tipados do Northwind ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image88.png))
...
**Figura 33**: Inspecione o código gerado automaticamente pela seleção de ir para definição do modo de exibição de classe
...
**Figura 34**: O **GetProducts()** método é agora parte das **Northwind.SuppliersRow** classe
...
[![TNome da empresa do fornecedor he está listado na coluna esquerda, seus produtos no canto direito](creating-a-data-access-layer-cs/_static/image92.png)](creating-a-data-access-layer-cs/_static/image91.png)

**Figura 35**: Nome da empresa do fornecedor está listado na coluna esquerda, seus produtos da direita ([clique para exibir a imagem em tamanho normal](creating-a-data-access-layer-cs/_static/image93.png))
