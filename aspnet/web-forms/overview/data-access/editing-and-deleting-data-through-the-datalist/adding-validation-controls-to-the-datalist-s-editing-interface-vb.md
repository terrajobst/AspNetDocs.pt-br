...
## <a name="step-1-replicating-the-example-fromhandling-bll--and-dal-level-exceptions"></a>Etapa 1: replicando o exemplo do[tratamento de exceções de nível de BLL e Dal](handling-bll-and-dal-level-exceptions-vb.md)
