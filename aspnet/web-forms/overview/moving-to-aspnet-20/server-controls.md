...
## <a name="step-1-call-the-registerrequirescontrolstate-method"></a>Etapa 1: Chame o método RegisterRequiresControlState
...
| --- | --- |
| Automático | O assistente determina automaticamente o tipo de etapa com base em sua posição dentro da hierarquia de etapa. |
...
| PassThrough | Marcação é renderizada como-está. |
