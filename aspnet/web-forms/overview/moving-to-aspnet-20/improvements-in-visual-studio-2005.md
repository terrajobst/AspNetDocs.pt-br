...
7. Clique em **Abrir**. O local do FTP será inserido na caixa de diálogo Novo Site da Web.
8. Clique em **OK**.
...
Para abrir um projeto da Web, selecione Abrir Site da Web no menu arquivo. Você será solicitado com a mesma caixa de diálogo Escolher local abordada anteriormente, e você tem as mesmas quatro opções disponíveis para você: Sistema de arquivos, Local IIS, FTP e sites remotos.
