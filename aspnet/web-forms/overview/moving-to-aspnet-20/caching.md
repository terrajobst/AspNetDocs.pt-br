...
| -d *database\_name* | Especifica o nome do banco de dados que deve ser habilitado para a dependência de cache SQL. |
...
| -t *table\_name* | Especifica o nome da tabela de banco de dados para habilitar a dependência de cache SQL. |
...
- Se o limite de bytes particulares do processo de trabalho não for definido, o cache usará um dos limites a seguir: 
    ...
    - x86 2GB: 800MB ou 60% da RAM física, o que for menor
...
## <a name="lab-2-using-polling-based-cache-dependencies"></a>Laboratório 2: Usando as dependências de Cache baseadas em sondagem
