...
ms.locfileid: "59415980"
---
# <a name="how-to-add-mobile-pages-to-your-aspnet-web-forms--mvc-application"></a>Como: Adicionar páginas móveis ao seu Web Forms do ASP.NET ou seu aplicativo do MVC
...
3. ***Resolver o problema no servidor* –** se seu servidor sabe qual dispositivo está acessando – ou pelo menos as características desse dispositivo, como seu tamanho da tela e o método de entrada, e se ele é um dispositivo móvel – pode ser executada uma lógica diferente e marcação HTML diferente de saída. 
    ...
    - **Vantagem:** Máximo de flexibilidade. Não há nenhum limite para quanto você pode variar sua lógica do lado do servidor para celulares ou otimizar sua marcação para o layout desejado, específico do dispositivo.
...
Agora, o erro irá distância e o URL http:\/\/*seusite*/ atingirá a home page da área de trabalho e o http:\/\/*seusite*/mobile/ será acessar a home page da móvel.
