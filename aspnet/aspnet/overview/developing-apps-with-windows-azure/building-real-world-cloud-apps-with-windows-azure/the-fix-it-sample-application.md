...
9. Para criar o aplicativo web para a base (não há filas de processamento) corrigi-lo o aplicativo, execute o script de criação do ambiente.
    ...
    Se o script falhar ou gerar erros, como "New-AzureWebsite: Em primeiro lugar, chamar Set-AzureSubscription e Select-AzureSubscription"você não pode ter concluído a configuração do Azure PowerShell.
...
> [Voltar](more-patterns-and-guidance.md)
