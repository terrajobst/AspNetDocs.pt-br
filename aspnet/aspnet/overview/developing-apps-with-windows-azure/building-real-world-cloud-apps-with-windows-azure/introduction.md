...
- [Automatizar tudo](automate-everything.md).
    ...
    - Demo: Scripts de gerenciamento do Azure.
...
- [Opções de armazenamento de dados](data-storage-options.md). 
    ...
    - Demo: Banco de dados SQL do Azure.
