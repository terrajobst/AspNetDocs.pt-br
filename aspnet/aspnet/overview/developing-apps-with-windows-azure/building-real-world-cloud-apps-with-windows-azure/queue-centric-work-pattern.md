...
- [Parte de filas de armazenamento do Microsoft Azure 1: Introdução ao](http://justazure.com/microsoft-azure-storage-queues-part-1-getting-started/). Article by Roman Schacherl.
