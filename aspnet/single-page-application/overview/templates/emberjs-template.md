...
- Scripts/helpers.js: Define os auxiliares de Handlebars Ember novo.
- Scripts/app.js: Cria o aplicativo e configura o adaptador e o serializador.
- App/scripts/modelos/\*. js: Define os modelos.
- Scripts/app/exibições/\*. js: Define os modos de exibição.
- App/scripts/controladores/\*. js: Define os controladores.
- Scripts/app/routes, Scripts/app/router.js: Define as rotas.
...
- About.HBS: O modelo de rota "/ sobre".
...
O `HtmlHelperExtensions` classe, definida na Controllers/HtmlHelperExtensions.cs, define um auxiliar de função em cache e inserir modelo arquivos ao **debug** é definido como **true** no arquivo Web. config. Essa função é chamada do arquivo de exibição do MVC do ASP.NET definido no Views/Home/App.cshtml:
