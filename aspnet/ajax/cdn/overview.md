...
#### <a name="jquery-version-341"></a>versão do jQuery 3.4.1
...
- [jQuery Validate 1.19.1](jquery-validate/cdnjqueryvalidate1191.md "1.19.1 de validação do jQuery")
- [jQuery Validate 1.19.0](jquery-validate/cdnjqueryvalidate1190.md "1.19.0 de validação do jQuery")
...
#### <a name="bootstrap-version-431"></a>Inicializar versão 4.3.1
...
#### <a name="bootstrap-version-421"></a>Inicializar versão 4.2.1
...
#### <a name="bootstrap-version-341"></a>Versão bootstrap 3.4.1
...
#### <a name="bootstrap-version-340"></a>Inicializar versão 3.4.0
