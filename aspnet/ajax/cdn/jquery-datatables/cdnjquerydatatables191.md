...
title: 1\.9.1 de DataTables do jQuery | Microsoft Docs
...
ms.locfileid: "78563199"
---
# <a name="jquery-datatables-191"></a><span data-ttu-id="04004-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="04004-102">jQuery DataTables 1.9.1</span></span>

<span data-ttu-id="04004-103">Os seguintes arquivos para os plug-ins do jQuery DataTables estão hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="04004-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
