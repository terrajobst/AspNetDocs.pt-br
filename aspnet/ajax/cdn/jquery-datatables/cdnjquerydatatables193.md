...
title: 1\.9.3 de DataTables do jQuery | Microsoft Docs
...
ms.locfileid: "78563178"
---
# <a name="jquery-datatables-193"></a><span data-ttu-id="95112-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="95112-102">jQuery DataTables 1.9.3</span></span>

<span data-ttu-id="95112-103">Os seguintes arquivos para os plug-ins do jQuery DataTables estão hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="95112-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
