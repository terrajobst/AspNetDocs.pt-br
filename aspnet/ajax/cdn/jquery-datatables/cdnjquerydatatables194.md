...
title: 1\.9.4 de DataTables do jQuery | Microsoft Docs
...
ms.locfileid: "78563206"
---
# <a name="jquery-datatables-194"></a><span data-ttu-id="acc8a-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="acc8a-102">jQuery DataTables 1.9.4</span></span>

<span data-ttu-id="acc8a-103">Os seguintes arquivos para os plug-ins do jQuery DataTables estão hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="acc8a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
