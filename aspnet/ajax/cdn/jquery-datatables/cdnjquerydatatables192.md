...
title: 1\.9.2 de DataTables do jQuery | Microsoft Docs
...
ms.locfileid: "78563171"
---
# <a name="jquery-datatables-192"></a><span data-ttu-id="6a302-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="6a302-102">jQuery DataTables 1.9.2</span></span>

<span data-ttu-id="6a302-103">Os seguintes arquivos para os plug-ins do jQuery DataTables estão hospedados na CDN:</span><span class="sxs-lookup"><span data-stu-id="6a302-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
