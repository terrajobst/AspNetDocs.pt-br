...
O painel sob o nome da tabela é onde você define as colunas individuais. Para o *filmes* tabela neste tutorial, você criará apenas algumas colunas: *ID*, *Title*, *gênero*, e *ano*.
