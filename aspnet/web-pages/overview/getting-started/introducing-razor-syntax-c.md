...
Sintaxe do Razor é uma sintaxe de programação simple para inserir código baseado em servidor em uma página da web. Em uma página da web que usa a sintaxe do Razor, há dois tipos de conteúdo: código de conteúdo e o servidor do cliente. Conteúdo do cliente é a coisa que você está acostumado em páginas da web: Marcação HTML (elementos), informações de estilo, como CSS, talvez alguns scripts de cliente, como JavaScript e texto sem formatação.
...
[Apêndice: Sintaxe e a linguagem Visual Basic](https://go.microsoft.com/fwlink/?LinkId=202908)
