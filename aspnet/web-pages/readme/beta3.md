...
> <span data-ttu-id="da9a7-127">Consulte [instruções passo a passo para a publicação de aplicativos](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="da9a7-127">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
> 
> <span data-ttu-id="da9a7-180">Por exemplo, a seguinte `@helper` sintaxe funciona na versão Beta 3:</span><span class="sxs-lookup"><span data-stu-id="da9a7-180">For example, the following `@helper` syntax works in the Beta 3 release:</span></span>
> 
...
> **<span data-ttu-id="da9a7-333">Solução alternativa</span><span class="sxs-lookup"><span data-stu-id="da9a7-333">Workaround</span></span>**  
...
> <span data-ttu-id="da9a7-386">Google Chrome não é exibido na lista de navegadores em **executados** sobre o **Home** guia.</span><span class="sxs-lookup"><span data-stu-id="da9a7-386">Google Chrome is not displayed in the list of browsers under **Run** on the **Home** tab.</span></span>
> 
...
> <span data-ttu-id="da9a7-401">No SQL Server Compact 4.0, se você não especificar um tipo de dados, como `SqlDbType` ou `DbType` para parâmetros em consultas parametrizadas, uma exceção é lançada quando a consulta é executada.</span><span class="sxs-lookup"><span data-stu-id="da9a7-401">In SQL Server Compact 4.0, if you do not specify a data type such as `SqlDbType` or `DbType` for parameters in parameterized queries, an exception is thrown when the query runs.</span></span>
> 
> **<span data-ttu-id="da9a7-402">Solução alternativa</span><span class="sxs-lookup"><span data-stu-id="da9a7-402">Workaround</span></span>**  
> <span data-ttu-id="da9a7-403">Definir explicitamente o tipo de dados para parâmetros, como `SqlDbType` ou `DbType`.</span><span class="sxs-lookup"><span data-stu-id="da9a7-403">Explicitly set the data type for parameters such as `SqlDbType` or `DbType`.</span></span> <span data-ttu-id="da9a7-404">Isso é importante no caso de tipos de dados BLOB (`image` e `ntext`).</span><span class="sxs-lookup"><span data-stu-id="da9a7-404">This is critical in the case of BLOB data types (`image` and `ntext`).</span></span> <span data-ttu-id="da9a7-405">Use o código semelhante ao seguinte:</span><span class="sxs-lookup"><span data-stu-id="da9a7-405">Use code like the following:</span></span>
> 
...
## <a name="for-more-information"></a><span data-ttu-id="da9a7-406">Para obter mais informações</span><span class="sxs-lookup"><span data-stu-id="da9a7-406">For More Information</span></span>

<span data-ttu-id="da9a7-407">Para obter mais informações sobre o WebMatrix Beta 3, consulte os seguintes sites:</span><span class="sxs-lookup"><span data-stu-id="da9a7-407">For more information about WebMatrix Beta 3, see the following websites:</span></span>

- [<span data-ttu-id="da9a7-408">IIS.net</span><span class="sxs-lookup"><span data-stu-id="da9a7-408">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="da9a7-409">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="da9a7-409">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="da9a7-410">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="da9a7-410">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

---

<span data-ttu-id="da9a7-411">© 2010 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="da9a7-411">© 2010 Microsoft Corporation.</span></span> <span data-ttu-id="da9a7-412">Todos os direitos reservados.</span><span class="sxs-lookup"><span data-stu-id="da9a7-412">All Rights Reserved.</span></span> <span data-ttu-id="da9a7-413">[Termos de uso](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="da9a7-413">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
