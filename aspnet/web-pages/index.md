...
- [Diretrizes](overview/index.md)
    ...
    - [Introdução](overview/getting-started/index.md)
        ...
        - [Adição de redes sociais em seu site](overview/getting-started/13-adding-social-networking-to-your-web-site.md)
    ...
    - [Versões](overview/releases/index.md)
        ...
        - [Executando versões diferentes de Páginas da Web do ASP.NET lado a lado](overview/releases/running-v1-and-v2-sites-side-by-side.md)
- [Vídeos](videos/index.md)
    ...
    - [Páginas do Razor do ASP.NET](videos/aspnet-razor-pages/index.md)
        ...
        - [Trabalhando com os dados (parte 1)](videos/aspnet-razor-pages/working-with-data-part-1.md)
        - [Trabalhando com os dados (parte 2)](videos/aspnet-razor-pages/working-with-data-part-2.md)
        ...
        - [Adição de redes sociais em seu site](videos/aspnet-razor-pages/adding-social-networking-to-your-website.md)
