...
O ASP.NET MVC framework oferece suporte ao uso de qualquer tecnologia de acesso a dados e os desenvolvedores podem escolher entre uma variedade de opções de dados avançadas do .NET para implementar seus modelos, incluindo: LINQ to entidades, LINQ to SQL, NHibernate, LLBLGen Pro, o SubSonic, WilsonORM, ou apenas brutos ADO.NET DataReaders ou conjuntos de dados.
...
Em seguida, podemos implementar nossa classe DinnerRepository usando o código a seguir:
