...
Se você não estiver familiarizado com os trechos de código do Visual Studio e aprender como usá-los, consulte o Apêndice deste documento &quot; [apêndice a: Usar trechos de código](#AppendixA)&quot;.
...
### <a name="exercise-2-creating-the-photo-gallery-web-application"></a>Exercício 2: Criando o aplicativo Web Galeria de fotos
...
> [!NOTE]
> Além disso, você pode implantar esse aplicativo para Windows Azure Web Sites seguinte [apêndice d: Publicando um aplicativo ASP.NET MVC 4 usando a implantação da Web](#AppendixD).
...
## <a name="appendix-c-installing-webmatrix-2-and-iphone-simulator"></a>Apêndice c: Instalar o WebMatrix 2 e o simulador do iPhone
