...
5. Substitua o resolvedor de dependência padrão ASP.NET MVC 4 com uma instância do **UnityDependencyResolver**. Para fazer isso, substitua **inicializar** método conteúdo com o código a seguir:
