...
1. [<span data-ttu-id="6f28f-139">Criando o controlador do Store Manager e sua exibição de índice</span><span class="sxs-lookup"><span data-stu-id="6f28f-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
<span data-ttu-id="6f28f-152">Nesta tarefa, você criará um novo controlador chamado **StoreManagerController** para dar suporte a operações CRUD.</span><span class="sxs-lookup"><span data-stu-id="6f28f-152">In this task, you will create a new controller called **StoreManagerController** to support CRUD operations.</span></span>
...
2. <span data-ttu-id="6f28f-161">Adicione um novo controlador.</span><span class="sxs-lookup"><span data-stu-id="6f28f-161">Add a new controller.</span></span> <span data-ttu-id="6f28f-162">Para fazer isso, clique com botão direito a **controladores** pasta dentro do Gerenciador de soluções, selecione **Add** e, em seguida, o **controlador** comando.</span><span class="sxs-lookup"><span data-stu-id="6f28f-162">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="6f28f-163">Alterar o **controlador** **nome** para **StoreManagerController** e verifique se a opção **controlador MVC com ações de leitura/gravação vazias**está selecionado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-163">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="6f28f-164">Clique em **Adicionar**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-164">Click **Add**.</span></span>
    ...
    <span data-ttu-id="6f28f-166">*Adicionar caixa de diálogo do controlador*</span><span class="sxs-lookup"><span data-stu-id="6f28f-166">*Add Controller Dialog*</span></span>
...
3. <span data-ttu-id="6f28f-175">Implemente a ação de índice StoreManagerController para retornar uma exibição com a lista dos álbuns.</span><span class="sxs-lookup"><span data-stu-id="6f28f-175">Implement the StoreManagerController Index action to return a View with the list of albums.</span></span>
    ...
    <span data-ttu-id="6f28f-178">(Código de trecho de código – *auxiliares do ASP.NET MVC 4, formulários e validação - Ex1 StoreManagerController índice*)</span><span class="sxs-lookup"><span data-stu-id="6f28f-178">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex1 StoreManagerController Index*)</span></span>
...
<span data-ttu-id="6f28f-214">![Procurar a lista de álbuns com texto não truncado](aspnet-mvc-4-helpers-forms-and-validation/_static/image5.png "procurar a lista de álbuns com texto não truncado")</span><span class="sxs-lookup"><span data-stu-id="6f28f-214">![Browsing the list of Albums with not truncated text](aspnet-mvc-4-helpers-forms-and-validation/_static/image5.png "Browsing the list of Albums with not truncated text")</span></span>
...
2. <span data-ttu-id="6f28f-264">Abra o **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="6f28f-264">Open the **StoreManagerController** class.</span></span> <span data-ttu-id="6f28f-265">Para fazer isso, expanda o **controladores** pasta e clique duas vezes em **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-265">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
...
<span data-ttu-id="6f28f-303">Agora que o modo de exibição Editar exibe conforme o esperado, você precisa implementar o método de ação Editar do HTTP POST para salvar as alterações feitas no álbum.</span><span class="sxs-lookup"><span data-stu-id="6f28f-303">Now that the Edit View displays as expected, you need to implement the HTTP-POST Edit Action method to save the changes made to the Album.</span></span>
...
1. <span data-ttu-id="6f28f-329">Um método de ação exibirá um formulário vazio quando os gerentes de loja primeiramente visite o **/StoreManager/criar** URL.</span><span class="sxs-lookup"><span data-stu-id="6f28f-329">One action method will display an empty form when store managers first visit the **/StoreManager/Create** URL.</span></span>
...
2. <span data-ttu-id="6f28f-342">Abra **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="6f28f-342">Open **StoreManagerController** class.</span></span> <span data-ttu-id="6f28f-343">Para fazer isso, expanda o **controladores** pasta e clique duas vezes em **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-343">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
...
3. <span data-ttu-id="6f28f-381">Verifique se que será redirecionado para o modo de exibição de índice StoreManager que inclui o novo álbum que acabou de criar.</span><span class="sxs-lookup"><span data-stu-id="6f28f-381">Verify that you get redirected to the StoreManager Index View that includes the new Album just created.</span></span>
    ...
    <span data-ttu-id="6f28f-383">*Novo álbum criado*</span><span class="sxs-lookup"><span data-stu-id="6f28f-383">*New Album Created*</span></span>
...
5. <span data-ttu-id="6f28f-408">Na caixa de diálogo Adicionar modo de exibição, verifique se o nome de exibição está **excluir**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="6f28f-409">Selecione o **criar uma exibição fortemente tipada** opção e selecione **álbum (MvcMusicStore.Models)** do **classe de modelo** lista suspensa.</span><span class="sxs-lookup"><span data-stu-id="6f28f-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="6f28f-410">Selecione **exclua** da **modelo Scaffold** lista suspensa.</span><span class="sxs-lookup"><span data-stu-id="6f28f-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="6f28f-411">Deixe os outros campos com seus valores padrão e, em seguida, clique em **adicionar**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="6f28f-412">![Adicionando uma exibição Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "adicionando uma exibição Delete")</span><span class="sxs-lookup"><span data-stu-id="6f28f-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="6f28f-413">*Adicionando uma exibição Delete*</span><span class="sxs-lookup"><span data-stu-id="6f28f-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="6f28f-414">O modelo de exclusão mostra todos os campos do modelo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="6f28f-415">Você mostrará apenas o título do álbum.</span><span class="sxs-lookup"><span data-stu-id="6f28f-415">You will show only the album's title.</span></span> <span data-ttu-id="6f28f-416">Para fazer isso, substitua o conteúdo do modo de exibição com o código a seguir:</span><span class="sxs-lookup"><span data-stu-id="6f28f-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="6f28f-417">Tarefa 2 - executando o aplicativo</span><span class="sxs-lookup"><span data-stu-id="6f28f-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="6f28f-418">Nesta tarefa, você testará que a **StoreManager** **excluir** página de exibição exibe um formulário de exclusão de confirmação.</span><span class="sxs-lookup"><span data-stu-id="6f28f-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="6f28f-419">Pressione **F5** para executar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f28f-420">O projeto é iniciado na Home page.</span><span class="sxs-lookup"><span data-stu-id="6f28f-420">The project starts in the Home page.</span></span> <span data-ttu-id="6f28f-421">Altere a URL para **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="6f28f-422">Selecionar um álbum para excluir clicando **excluir** e verificar se o novo modo de exibição é carregado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="6f28f-423">![Exclusão de um álbum](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "exclusão de um álbum")</span><span class="sxs-lookup"><span data-stu-id="6f28f-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="6f28f-424">*Exclusão de um álbum*</span><span class="sxs-lookup"><span data-stu-id="6f28f-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="6f28f-425">Tarefa 3-Implementando o método de ação de exclusão de HTTP POST</span><span class="sxs-lookup"><span data-stu-id="6f28f-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="6f28f-426">Nesta tarefa, você implementará a versão do HTTP POST do método de ação de exclusão que será invocado quando um usuário clica o **excluir** botão.</span><span class="sxs-lookup"><span data-stu-id="6f28f-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="6f28f-427">O método deve excluir o álbum no banco de dados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="6f28f-428">Feche o navegador, se necessário, para retornar à janela do Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="6f28f-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="6f28f-429">Abra **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="6f28f-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="6f28f-430">Para fazer isso, expanda o **controladores** pasta e clique duas vezes em **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="6f28f-431">Substitua **HTTP-POST excluir** código do método de ação com o seguinte:</span><span class="sxs-lookup"><span data-stu-id="6f28f-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="6f28f-432">(Código de trecho de código – *auxiliares do ASP.NET MVC 4, formulários e validação - HTTP-POST exclusão Ex5 tratamento excluir ação*)</span><span class="sxs-lookup"><span data-stu-id="6f28f-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="6f28f-433">Tarefa 4 - execução do aplicativo</span><span class="sxs-lookup"><span data-stu-id="6f28f-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="6f28f-434">Nesta tarefa, você testará que a **StoreManager Delete** página de exibição permite que você exclua um álbum e, em seguida, redireciona para o modo de exibição de índice StoreManager.</span><span class="sxs-lookup"><span data-stu-id="6f28f-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="6f28f-435">Pressione **F5** para executar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f28f-436">O projeto é iniciado na Home page.</span><span class="sxs-lookup"><span data-stu-id="6f28f-436">The project starts in the Home page.</span></span> <span data-ttu-id="6f28f-437">Altere a URL para **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="6f28f-438">Selecionar um álbum para excluir clicando **excluir.**</span><span class="sxs-lookup"><span data-stu-id="6f28f-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="6f28f-439">Confirmar a exclusão clicando **excluir** botão:</span><span class="sxs-lookup"><span data-stu-id="6f28f-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="6f28f-440">![Exclusão de um álbum](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "exclusão de um álbum")</span><span class="sxs-lookup"><span data-stu-id="6f28f-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="6f28f-441">*Exclusão de um álbum*</span><span class="sxs-lookup"><span data-stu-id="6f28f-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="6f28f-442">Verifique se o álbum foi excluído, pois ele não aparece na **índice** página.</span><span class="sxs-lookup"><span data-stu-id="6f28f-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="6f28f-443">Exercício 6: Adicionando uma Validação</span><span class="sxs-lookup"><span data-stu-id="6f28f-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="6f28f-444">Atualmente, as formas de criar e editar, que você tem em vigor não executam qualquer tipo de validação.</span><span class="sxs-lookup"><span data-stu-id="6f28f-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="6f28f-445">Se o usuário deixar um campo obrigatório em branco ou tipo letras no campo de preço, o primeiro erro que você obterá será do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="6f28f-446">Você pode adicionar validação para o aplicativo com a adição de anotações de dados à sua classe de modelo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="6f28f-447">Anotações de dados permitem que descreve as regras que você deseja que sejam aplicadas às suas propriedades de modelo e ASP.NET MVC se encarregará de imposição e exibindo a mensagem apropriada para os usuários.</span><span class="sxs-lookup"><span data-stu-id="6f28f-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="6f28f-448">Tarefa 1: adicionar anotações de dados</span><span class="sxs-lookup"><span data-stu-id="6f28f-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="6f28f-449">Nesta tarefa, você irá adicionar anotações de dados para o modelo de álbum que tornarão a página criar e editar exibir mensagens de validação quando apropriado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="6f28f-450">Para uma classe de modelo simple, adicionar uma anotação de dados é tratada apenas adicionando um **usando** instrução para **System.ComponentModel.DataAnnotation**, em seguida, colocar um **[obrigatório]** atributo sobre as propriedades adequadas.</span><span class="sxs-lookup"><span data-stu-id="6f28f-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="6f28f-451">O exemplo a seguir faria o **nome** um campo obrigatório no modo de exibição da propriedade.</span><span class="sxs-lookup"><span data-stu-id="6f28f-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="6f28f-452">Isso é um pouco mais complexo em casos como esse aplicativo em que o modelo de dados de entidade é gerado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="6f28f-453">Se você adicionar anotações de dados diretamente para as classes de modelo, eles serão substituídos se você atualizar o modelo do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="6f28f-454">Em vez disso, você pode fazer uso de classes parciais de metadados que existirão para manter as anotações e estão associadas com o modelo de classes usando o **[MetadataType]** atributo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="6f28f-455">Abra o **começar** solução localizado em **origem/Ex6-AddingValidation/início/** pasta.</span><span class="sxs-lookup"><span data-stu-id="6f28f-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="6f28f-456">Caso contrário, você pode continuar usando o **final** solução obtida ao concluir o exercício anterior.</span><span class="sxs-lookup"><span data-stu-id="6f28f-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="6f28f-457">Se você abriu fornecido **começar** solução, você precisará baixar alguns pacotes do NuGet ausentes antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="6f28f-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="6f28f-458">Para fazer isso, clique o **Project** menu e selecione **Manage NuGet Packages**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="6f28f-459">No **gerenciar pacotes NuGet** caixa de diálogo, clique em **restaurar** para baixar os pacotes ausentes.</span><span class="sxs-lookup"><span data-stu-id="6f28f-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="6f28f-460">Por fim, compile a solução clicando **construir** | **compilar solução**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="6f28f-461">Uma das vantagens de usar o NuGet é que você não precisa enviar todas as bibliotecas em seu projeto, reduzindo o tamanho do projeto.</span><span class="sxs-lookup"><span data-stu-id="6f28f-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="6f28f-462">Com o NuGet Power Tools, especificando as versões do pacote no arquivo Packages. config, você será capaz de baixar todas as bibliotecas necessárias na primeira vez em que você executar o projeto.</span><span class="sxs-lookup"><span data-stu-id="6f28f-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="6f28f-463">É por isso você terá que executar essas etapas depois de abrir uma solução existente neste laboratório.</span><span class="sxs-lookup"><span data-stu-id="6f28f-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="6f28f-464">Abra o **Album.cs** da **modelos** pasta.</span><span class="sxs-lookup"><span data-stu-id="6f28f-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="6f28f-465">Substitua **Album.cs** de conteúdo com o código realçado, para que ele é semelhante ao seguinte:</span><span class="sxs-lookup"><span data-stu-id="6f28f-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="6f28f-466">A linha **[DisplayFormat(ConvertEmptyStringToNull=false)]** indica que as cadeias de caracteres vazias do modelo de não ser convertidas em nulo quando o campo de dados é atualizado na fonte de dados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="6f28f-467">Essa configuração irá evitar uma exceção quando o Entity Framework atribui valores nulos para o modelo antes de anotação de dados valida os campos.</span><span class="sxs-lookup"><span data-stu-id="6f28f-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="6f28f-468">(Código de trecho de código – *auxiliares do ASP.NET MVC 4, formulários e validação - classe parcial de metadados de álbum Ex6*)</span><span class="sxs-lookup"><span data-stu-id="6f28f-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="6f28f-469">Isso **álbum** classe parcial tem um **MetadataType** atributo que aponta para o **AlbumMetaData** classe para as anotações de dados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="6f28f-470">Estes são alguns dos atributos de anotação de dados que você está usando para anotar o modelo de álbum:</span><span class="sxs-lookup"><span data-stu-id="6f28f-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="6f28f-471">Exigido - indica que a propriedade é um campo obrigatório</span><span class="sxs-lookup"><span data-stu-id="6f28f-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="6f28f-472">DisplayName - define o texto a ser usado em campos de formulário e mensagens de validação</span><span class="sxs-lookup"><span data-stu-id="6f28f-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="6f28f-473">DisplayFormat - Especifica como os campos de dados são exibidos e formatados.</span><span class="sxs-lookup"><span data-stu-id="6f28f-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="6f28f-474">StringLength - define um comprimento máximo para um campo de cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="6f28f-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="6f28f-475">Intervalo - retorna um valor mínimo e máximo para um campo numérico</span><span class="sxs-lookup"><span data-stu-id="6f28f-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="6f28f-476">ScaffoldColumn - permite ocultar campos de formulários do editor</span><span class="sxs-lookup"><span data-stu-id="6f28f-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="6f28f-477">Tarefa 2 - executando o aplicativo</span><span class="sxs-lookup"><span data-stu-id="6f28f-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="6f28f-478">Nesta tarefa, você testará que as páginas criar e editar validam campos, usando os nomes de exibição escolhidos na última tarefa.</span><span class="sxs-lookup"><span data-stu-id="6f28f-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="6f28f-479">Pressione **F5** para executar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="6f28f-480">O projeto é iniciado na Home page.</span><span class="sxs-lookup"><span data-stu-id="6f28f-480">The project starts in the Home page.</span></span> <span data-ttu-id="6f28f-481">Altere a URL para **/StoreManager/criar**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="6f28f-482">Verifique se os nomes de exibição correspondem aqueles na classe parcial (como **URL de arte do álbum** em vez de **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="6f28f-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="6f28f-483">Clique em **criar**, sem preenchendo o formulário.</span><span class="sxs-lookup"><span data-stu-id="6f28f-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="6f28f-484">Verifique se que você obtenha as mensagens de validação correspondentes.</span><span class="sxs-lookup"><span data-stu-id="6f28f-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="6f28f-485">![Validar campos na página criar](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "validado campos na página criar")</span><span class="sxs-lookup"><span data-stu-id="6f28f-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="6f28f-486">*Campos validados na página criar*</span><span class="sxs-lookup"><span data-stu-id="6f28f-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="6f28f-487">Você pode verificar se o mesmo ocorre com o **editar** página.</span><span class="sxs-lookup"><span data-stu-id="6f28f-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="6f28f-488">Altere a URL para **/StoreManager/Edit/1** e verifique se os nomes de exibição correspondem aqueles na classe parcial (como **URL de arte do álbum** em vez de **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="6f28f-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="6f28f-489">Vazio a **Title** e **preço** campos e clique em **salvar**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="6f28f-490">Verifique se que você obtenha as mensagens de validação correspondentes.</span><span class="sxs-lookup"><span data-stu-id="6f28f-490">Verify that you get the corresponding validation messages.</span></span>

    ![Campos validados na página Editar](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="6f28f-492">*Campos validados na página Editar*</span><span class="sxs-lookup"><span data-stu-id="6f28f-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="6f28f-493">Exercício 7: Usando o jQuery Unobtrusive no lado do cliente</span><span class="sxs-lookup"><span data-stu-id="6f28f-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="6f28f-494">Neste exercício, você aprenderá como habilitar a validação não invasiva MVC 4 do jQuery no lado do cliente.</span><span class="sxs-lookup"><span data-stu-id="6f28f-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="6f28f-495">O jQuery Unobtrusive usa o prefixo de dados ajax JavaScript para invocar métodos de ação no servidor em vez de scripts de cliente forma invasiva emitindo embutido.</span><span class="sxs-lookup"><span data-stu-id="6f28f-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="6f28f-496">Tarefa 1: executar o aplicativo antes de habilitar discreto jQuery</span><span class="sxs-lookup"><span data-stu-id="6f28f-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="6f28f-497">Nesta tarefa, você executará o aplicativo antes de incluir jQuery para comparar os dois modelos de validação.</span><span class="sxs-lookup"><span data-stu-id="6f28f-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="6f28f-498">Abra o **começar** solução localizado em **origem/Ex7-UnobtrusivejQueryValidation/início/** pasta.</span><span class="sxs-lookup"><span data-stu-id="6f28f-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="6f28f-499">Caso contrário, você pode continuar usando o **final** solução obtida ao concluir o exercício anterior.</span><span class="sxs-lookup"><span data-stu-id="6f28f-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="6f28f-500">Se você abriu fornecido **começar** solução, você precisará baixar alguns pacotes do NuGet ausentes antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="6f28f-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="6f28f-501">Para fazer isso, clique o **Project** menu e selecione **Manage NuGet Packages**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="6f28f-502">No **gerenciar pacotes NuGet** caixa de diálogo, clique em **restaurar** para baixar os pacotes ausentes.</span><span class="sxs-lookup"><span data-stu-id="6f28f-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="6f28f-503">Por fim, compile a solução clicando **construir** | **compilar solução**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="6f28f-504">Uma das vantagens de usar o NuGet é que você não precisa enviar todas as bibliotecas em seu projeto, reduzindo o tamanho do projeto.</span><span class="sxs-lookup"><span data-stu-id="6f28f-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="6f28f-505">Com o NuGet Power Tools, especificando as versões do pacote no arquivo Packages. config, você será capaz de baixar todas as bibliotecas necessárias na primeira vez em que você executar o projeto.</span><span class="sxs-lookup"><span data-stu-id="6f28f-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="6f28f-506">É por isso você terá que executar essas etapas depois de abrir uma solução existente neste laboratório.</span><span class="sxs-lookup"><span data-stu-id="6f28f-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="6f28f-507">Pressione **F5** para executar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="6f28f-508">O projeto é iniciado na Home page.</span><span class="sxs-lookup"><span data-stu-id="6f28f-508">The project starts in the Home page.</span></span> <span data-ttu-id="6f28f-509">Navegue **/StoreManager/Create** e clique em **criar** sem preenchendo o formulário para verificar que você obtenha as mensagens de validação:</span><span class="sxs-lookup"><span data-stu-id="6f28f-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="6f28f-510">![Validação de cliente desabilitada](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "desabilitada a validação do cliente")</span><span class="sxs-lookup"><span data-stu-id="6f28f-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="6f28f-511">*Validação de cliente desabilitada*</span><span class="sxs-lookup"><span data-stu-id="6f28f-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="6f28f-512">No navegador, abra o código-fonte HTML:</span><span class="sxs-lookup"><span data-stu-id="6f28f-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="6f28f-513">Tarefa 2 - Habilitar validação de cliente discreto</span><span class="sxs-lookup"><span data-stu-id="6f28f-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="6f28f-514">Nesta tarefa, você habilitará o jQuery **validação do cliente não invasiva** de **Web. config** arquivo, que é definido como false em todos os novos projetos do ASP.NET MVC 4 por padrão.</span><span class="sxs-lookup"><span data-stu-id="6f28f-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="6f28f-515">Além disso, você adicionará que o necessário scripts referências para tornar o trabalho de validação não invasiva do cliente do jQuery.</span><span class="sxs-lookup"><span data-stu-id="6f28f-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="6f28f-516">Abra **Web. config** do arquivo na raiz do projeto e certifique-se de que o **ClientValidationEnabled** e **UnobtrusiveJavaScriptEnabled** valores de chaves são definidos como **verdadeiro**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="6f28f-517">Você também pode habilitar a validação do cliente pelo código em Global.asax.cs para obter os mesmos resultados:</span><span class="sxs-lookup"><span data-stu-id="6f28f-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="6f28f-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="6f28f-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="6f28f-519">Além disso, você pode atribuir o atributo ClientValidationEnabled em qualquer controlador de ter um comportamento personalizado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="6f28f-520">Abra **Create. cshtml** na **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="6f28f-521">Verifique se os seguintes arquivos de script, **jQuery. Validate** e **jquery.validate.unobtrusive**, são referenciadas na exibição por meio do &quot; **~/bundles/jqueryval** &quot; pacote.</span><span class="sxs-lookup"><span data-stu-id="6f28f-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view through the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="6f28f-522">Todas essas bibliotecas de jQuery são incluídas em novos projetos de MVC 4.</span><span class="sxs-lookup"><span data-stu-id="6f28f-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="6f28f-523">Você pode encontrar mais bibliotecas na **/Scripts** pasta do projeto.</span><span class="sxs-lookup"><span data-stu-id="6f28f-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="6f28f-524">Para fazer essa validação bibliotecas funcionam, você precisará adicionar uma referência à biblioteca jQuery do framework.</span><span class="sxs-lookup"><span data-stu-id="6f28f-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="6f28f-525">Uma vez que essa referência já foi adicionada a  **\_layout. cshtml** arquivo, você não precisará adicioná-lo neste modo de exibição específico.</span><span class="sxs-lookup"><span data-stu-id="6f28f-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="6f28f-526">Tarefa 3: executar a validação do jQuery Unobtrusive de aplicativo usando</span><span class="sxs-lookup"><span data-stu-id="6f28f-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="6f28f-527">Nesta tarefa, você testará que a **StoreManager** criar exibição de modelo executa a validação do lado do cliente usando bibliotecas de jQuery quando o usuário cria um novo álbum.</span><span class="sxs-lookup"><span data-stu-id="6f28f-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="6f28f-528">Pressione **F5** para executar o aplicativo.</span><span class="sxs-lookup"><span data-stu-id="6f28f-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="6f28f-529">O projeto é iniciado na Home page.</span><span class="sxs-lookup"><span data-stu-id="6f28f-529">The project starts in the Home page.</span></span> <span data-ttu-id="6f28f-530">Navegue **/StoreManager/Create** e clique em **criar** sem preenchendo o formulário para verificar que você obtenha as mensagens de validação:</span><span class="sxs-lookup"><span data-stu-id="6f28f-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="6f28f-531">![Validação do cliente com o jQuery habilitada](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "validação do cliente com o jQuery habilitado")</span><span class="sxs-lookup"><span data-stu-id="6f28f-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="6f28f-532">*Validação do cliente com o jQuery habilitado*</span><span class="sxs-lookup"><span data-stu-id="6f28f-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="6f28f-533">No navegador, abra o código-fonte para criar exibição:</span><span class="sxs-lookup"><span data-stu-id="6f28f-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="6f28f-534">Para cada regra de validação do cliente, o jQuery Unobtrusive adiciona um atributo com os dados-- val*rulename*=&quot;*mensagem*&quot;.</span><span class="sxs-lookup"><span data-stu-id="6f28f-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="6f28f-535">Abaixo está uma lista de marcas que Unobtrusive jQuery insere no campo de entrada html para executar a validação do cliente:</span><span class="sxs-lookup"><span data-stu-id="6f28f-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="6f28f-536">Dados val</span><span class="sxs-lookup"><span data-stu-id="6f28f-536">Data-val</span></span>
   > - <span data-ttu-id="6f28f-537">Número de dados val</span><span class="sxs-lookup"><span data-stu-id="6f28f-537">Data-val-number</span></span>
   > - <span data-ttu-id="6f28f-538">Intervalo de dados val</span><span class="sxs-lookup"><span data-stu-id="6f28f-538">Data-val-range</span></span>
   > - <span data-ttu-id="6f28f-539">Data-val-intervalo-min / dados val-intervalo máximo</span><span class="sxs-lookup"><span data-stu-id="6f28f-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="6f28f-540">Dados val necessários</span><span class="sxs-lookup"><span data-stu-id="6f28f-540">Data-val-required</span></span>
   > - <span data-ttu-id="6f28f-541">Comprimento de dados val</span><span class="sxs-lookup"><span data-stu-id="6f28f-541">Data-val-length</span></span>
   > - <span data-ttu-id="6f28f-542">Data-val comprimento máx / dados val-comprimento mínimo</span><span class="sxs-lookup"><span data-stu-id="6f28f-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="6f28f-543">Todos os valores de dados são preenchidos com o modelo **anotação de dados**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="6f28f-544">Em seguida, toda a lógica que funciona no lado do servidor pode ser executada no lado do cliente.</span><span class="sxs-lookup"><span data-stu-id="6f28f-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="6f28f-545">Por exemplo, o atributo de preço tem a anotação de dados a seguir no modelo:</span><span class="sxs-lookup"><span data-stu-id="6f28f-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="6f28f-546">Depois de usar jQuery discreto, o código gerado é:</span><span class="sxs-lookup"><span data-stu-id="6f28f-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="6f28f-547">Resumo</span><span class="sxs-lookup"><span data-stu-id="6f28f-547">Summary</span></span>

<span data-ttu-id="6f28f-548">Ao concluir este laboratório prático, você aprendeu como habilitar usuários para alterar os dados armazenados no banco de dados com o uso das seguintes opções:</span><span class="sxs-lookup"><span data-stu-id="6f28f-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="6f28f-549">Ações do controlador, como o índice, criar, editar, excluir</span><span class="sxs-lookup"><span data-stu-id="6f28f-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="6f28f-550">Recurso de scaffolding de ASP.NET MVC para exibir as propriedades em uma tabela HTML</span><span class="sxs-lookup"><span data-stu-id="6f28f-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="6f28f-551">Experiência de auxiliares HTML personalizados para melhorar o usuário</span><span class="sxs-lookup"><span data-stu-id="6f28f-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="6f28f-552">Métodos de ação que reagem a HTTP-GET ou chamadas de HTTP POST</span><span class="sxs-lookup"><span data-stu-id="6f28f-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="6f28f-553">Um modelo compartilhado editor de modelos de exibição semelhantes, como criar e editar</span><span class="sxs-lookup"><span data-stu-id="6f28f-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="6f28f-554">Elementos de formulário, como listas suspensas</span><span class="sxs-lookup"><span data-stu-id="6f28f-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="6f28f-555">Anotações de dados para a validação do modelo</span><span class="sxs-lookup"><span data-stu-id="6f28f-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="6f28f-556">Validação do lado do cliente usando a biblioteca não invasiva do jQuery</span><span class="sxs-lookup"><span data-stu-id="6f28f-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="6f28f-557">Apêndice a: Instalar o Visual Studio Express 2012 para Web</span><span class="sxs-lookup"><span data-stu-id="6f28f-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="6f28f-558">Você pode instalar **Microsoft Visual Studio Express 2012 para Web** ou outra &quot;Express&quot; versão usando o **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="6f28f-559">As instruções a seguir guia você pelas etapas necessárias para instalar *Visual studio Express 2012 para Web* usando *Microsoft Web Platform Installer*.</span><span class="sxs-lookup"><span data-stu-id="6f28f-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="6f28f-560">Vá para [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="6f28f-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="6f28f-561">Como alternativa, se você já tiver instalado o Web Platform Installer, você pode abri-lo e pesquisar o produto &quot; <em>Visual Studio Express 2012 para Web com o SDK do Windows Azure</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="6f28f-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="6f28f-562">Clique em **instalar agora**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-562">Click on **Install Now**.</span></span> <span data-ttu-id="6f28f-563">Se você não tiver **Web Platform Installer** você será redirecionado para baixar e instalá-lo primeiro.</span><span class="sxs-lookup"><span data-stu-id="6f28f-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="6f28f-564">Uma vez **Web Platform Installer** é aberto, clique em **instalar** para iniciar a instalação.</span><span class="sxs-lookup"><span data-stu-id="6f28f-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="6f28f-565">![Instalar o Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "instalar o Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="6f28f-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="6f28f-566">*Instalar o Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="6f28f-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="6f28f-567">Leia os termos e licenças de todos os produtos e clique em **aceito** para continuar.</span><span class="sxs-lookup"><span data-stu-id="6f28f-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Aceitar os termos de licença](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="6f28f-569">*Aceitar os termos de licença*</span><span class="sxs-lookup"><span data-stu-id="6f28f-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="6f28f-570">Aguarde até que o processo de download e instalação for concluído.</span><span class="sxs-lookup"><span data-stu-id="6f28f-570">Wait until the downloading and installation process completes.</span></span>

    ![Progresso da instalação](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="6f28f-572">*Progresso da instalação*</span><span class="sxs-lookup"><span data-stu-id="6f28f-572">*Installation progress*</span></span>
6. <span data-ttu-id="6f28f-573">Quando a instalação for concluída, clique em **concluir**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-573">When the installation completes, click **Finish**.</span></span>

    ![Instalação concluída](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="6f28f-575">*Instalação concluída*</span><span class="sxs-lookup"><span data-stu-id="6f28f-575">*Installation completed*</span></span>
7. <span data-ttu-id="6f28f-576">Clique em **Exit** para fechar o Web Platform Installer.</span><span class="sxs-lookup"><span data-stu-id="6f28f-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="6f28f-577">Para abrir o Visual Studio Express para Web, vá para o **iniciar** de tela e comece a escrever &quot; **VS Express**&quot;, em seguida, clique no **VS Express para Web** lado a lado.</span><span class="sxs-lookup"><span data-stu-id="6f28f-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express para o bloco da Web](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="6f28f-579">*VS Express para o bloco da Web*</span><span class="sxs-lookup"><span data-stu-id="6f28f-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="6f28f-580">Apêndice b: Usar trechos de código</span><span class="sxs-lookup"><span data-stu-id="6f28f-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="6f28f-581">Com trechos de código, você tem todo o código que necessário ao seu alcance.</span><span class="sxs-lookup"><span data-stu-id="6f28f-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="6f28f-582">O documento de laboratório lhe dirá exatamente quando você pode usá-los, conforme mostrado na figura a seguir.</span><span class="sxs-lookup"><span data-stu-id="6f28f-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="6f28f-583">![Usar trechos de código do Visual Studio para inserir código em seu projeto](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "trechos de código usando o Visual Studio para inserir código em seu projeto")</span><span class="sxs-lookup"><span data-stu-id="6f28f-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="6f28f-584">*Usar trechos de código do Visual Studio para inserir código em seu projeto*</span><span class="sxs-lookup"><span data-stu-id="6f28f-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="6f28f-585">***Para adicionar um trecho de código usando o teclado (somente c#)***</span><span class="sxs-lookup"><span data-stu-id="6f28f-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="6f28f-586">Coloque o cursor onde você deseja inserir o código.</span><span class="sxs-lookup"><span data-stu-id="6f28f-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="6f28f-587">Comece a digitar o nome do trecho de código (sem espaços ou hifens).</span><span class="sxs-lookup"><span data-stu-id="6f28f-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="6f28f-588">Assista como o IntelliSense exibe os nomes dos trechos de código correspondentes.</span><span class="sxs-lookup"><span data-stu-id="6f28f-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="6f28f-589">Selecione o trecho de código correto (ou continue digitando até que o nome do trecho toda está selecionado).</span><span class="sxs-lookup"><span data-stu-id="6f28f-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="6f28f-590">Pressione a tecla Tab duas vezes para inserir o trecho de código no local do cursor.</span><span class="sxs-lookup"><span data-stu-id="6f28f-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="6f28f-591">![Comece a digitar o nome do trecho](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "comece a digitar o nome do trecho de código")</span><span class="sxs-lookup"><span data-stu-id="6f28f-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="6f28f-592">*Comece a digitar o nome do trecho de código*</span><span class="sxs-lookup"><span data-stu-id="6f28f-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="6f28f-593">![Pressione Tab para selecionar o trecho de código realçado](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "pressione Tab para selecionar o trecho de código realçado")</span><span class="sxs-lookup"><span data-stu-id="6f28f-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="6f28f-594">*Pressione Tab para selecionar o trecho de código realçado*</span><span class="sxs-lookup"><span data-stu-id="6f28f-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="6f28f-595">![Pressione Tab novamente e o trecho de código serão expandido](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "pressione Tab novamente e o trecho de código serão expandido")</span><span class="sxs-lookup"><span data-stu-id="6f28f-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="6f28f-596">*Pressione Tab novamente e o trecho de código serão expandido*</span><span class="sxs-lookup"><span data-stu-id="6f28f-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="6f28f-597">***Para adicionar um trecho de código usando o mouse (c#, Visual Basic e XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="6f28f-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="6f28f-598">Clique com botão direito no qual você deseja inserir o trecho de código.</span><span class="sxs-lookup"><span data-stu-id="6f28f-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="6f28f-599">Selecione **Inserir trecho** seguido **Meus trechos de código**.</span><span class="sxs-lookup"><span data-stu-id="6f28f-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="6f28f-600">Selecione o trecho relevante na lista, clicando nele.</span><span class="sxs-lookup"><span data-stu-id="6f28f-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="6f28f-601">![Clique com botão direito no qual você deseja inserir o trecho de código e selecione Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "botão direito do mouse em que você deseja inserir o trecho de código e selecione Insert Snippet")</span><span class="sxs-lookup"><span data-stu-id="6f28f-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="6f28f-602">*Clique com botão direito no qual você deseja inserir o trecho de código e selecione Insert Snippet*</span><span class="sxs-lookup"><span data-stu-id="6f28f-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="6f28f-603">![Escolher o trecho relevante na lista, clicando nele](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "escolher o trecho relevante na lista, clicando nele")</span><span class="sxs-lookup"><span data-stu-id="6f28f-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="6f28f-604">*Escolher o trecho relevante na lista, clicando nele*</span><span class="sxs-lookup"><span data-stu-id="6f28f-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
