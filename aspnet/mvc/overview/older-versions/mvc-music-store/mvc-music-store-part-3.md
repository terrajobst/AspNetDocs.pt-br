...
## <a name="adding-a-view-template"></a><span data-ttu-id="cedd3-114">Adicionando um modelo de exibição</span><span class="sxs-lookup"><span data-stu-id="cedd3-114">Adding a View template</span></span>
