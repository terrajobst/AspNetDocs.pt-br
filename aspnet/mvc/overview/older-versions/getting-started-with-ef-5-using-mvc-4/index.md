...
- [Criar um modelo de dados do Entity Framework](creating-an-entity-framework-data-model-for-an-asp-net-mvc-application.md)
...
- [Implementar os padrões de repositório e de unidade de trabalho](implementing-the-repository-and-unit-of-work-patterns-in-an-asp-net-mvc-application.md)
