...
> - [<span data-ttu-id="49a3f-115">Usar o Inspetor de página para procurar a uma exibição</span><span class="sxs-lookup"><span data-stu-id="49a3f-115">Use Page Inspector to Browse to a View</span></span>](#_3_using_page)
