...
Para obter uma versão atualizada deste tutorial que usa o .NET Core, consulte [confirmação da conta e recuperação de senha em ASP.NET Core](/aspnet/core/security/authentication/accconfirm).
