...
- Um token de segurança, consistindo de um identificador aleatório de 128 bits.   
 A imagem a seguir mostra o token de sessão de verificação do XSRF solicitação exibido com as ferramentas de desenvolvedor F12 do Internet Explorer: (Observe que essa é a implementação atual e está sujeita, provavelmente, a alteração.)
